...
import TestimonialEditModal from '../shared/TestimonialEditModal';
import TestimonialConfirmModal from '../shared/TestimonialConfirmModal';
import type { Testimonial } from '../../hooks/useSupabaseTestimonials';
...
const AdminTestimonials: React.FC = () => {
  ...
  const handleConfirmAction = async () => {
    ...
    try {
      switch (type) {
        case 'soft_delete':
          await softDeleteTestimonial(testimonialId);
          break;
        case 'restore':
          await restoreTestimonial(testimonialId);
          break;
        case 'hard_delete':
          await hardDeleteTestimonial(testimonialId);
          break;
      }
      setShowModal(false);
    } catch (error) {
